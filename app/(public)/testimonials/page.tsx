      ...
      <section className="py-12 lg:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
            ...
            <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-xl border border-slate-200 text-xs font-bold text-slate-700 shadow-xs">
              <div className="flex text-amber-400">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-3.5 h-3.5 fill-amber-400" />
                ))}
              </div>
              <span>4.9 / 5.0 (312+ Total Reviews)</span>
            </div>
          </div>
            ...
            {testimonials.map((t) => (
              ...
              >
                <div>
                  ...
                  {t.treatment && (
                    <span className="inline-block text-xs font-semibold text-teal-700 mb-3 bg-teal-50 px-2.5 py-0.5 rounded-md">
                      {t.treatment}
                    </span>
                  )}
                ...
                <div className="mt-8 pt-4 border-t border-slate-100 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-[#0A363D] text-white font-bold text-xs flex items-center justify-center">
