...
export const defaultHomepageCMS: HomepageCMS = {
  announcement: {
    text: 'Now accepting appointments for In-Clinic & Home Visit Physiotherapy in Perungudi & South Chennai.',
    enabled: true,
    linkText: 'Book Slot',
    linkUrl: '/appointment',
  },
  ...
  aboutClinic: {
    ...
    bulletPoints: [
      ...
      'Dedicated in-clinic sessions & personalized home visit rehabilitation',
    ],
...
export const defaultServices: ServiceItem[] = [
  ...
  },
  {
    ...
    shortDescription: 'Compassionate, one-on-one physiotherapy delivered at your doorstep for elderly, post-operative, and mobility-restricted patients.',
    longDescription: 'For patients recovering from major orthopedic surgeries (Total Knee Replacement, Hip Replacement, Spine Surgery), stroke survivors, or seniors with severe pain and limited mobility, traveling to the clinic can be painful and exhausting. GG Physiotherapy Clinic provides professional, dedicated Home Visit Physiotherapy across Perungudi, Velachery, Thoraipakkam, Madipakkam, and the OMR Chennai corridor. Our qualified physiotherapists bring essential rehabilitation tools directly to your residence to ensure continuous, supervised recovery.',
    heroImage: 'https://images.unsplash.com/photo-1576765608535-5f04d1e3f289?auto=format&fit=crop&w=1200&q=80',
    thumbnail: 'https://images.unsplash.com/photo-1576765608535-5f04d1e3f289?auto=format&fit=crop&w=600&q=80',
    benefits: [
      'Personalized physical rehabilitation in the comfort and safety of your home',
      'Eliminates the stress and pain of traveling for seniors or post-operative patients',
      'Bed-mobility, safe chair-to-bed transfers, and progressive gait re-education',
      'Home safety and fall-prevention evaluation by experienced physiotherapists',
      'Flexible scheduling coordinated around patient and family convenience',
    ],
    treatmentApproach: 'Bedside mobility training, assisted joint mobilization, portable electrotherapy modalities (TENS/IFT), progressive walker/cane gait retraining, and customized home exercise programming.',
    suitableFor: [
      'Post-Operative Patients (Total Knee Replacement, Hip Replacement, Fracture Fixation)',
      'Stroke & Neurological recovery patients unable to commute safely',
      'Elderly individuals with severe knee osteoarthritis or high fall risk',
      'Acute lumbar disc pain or sciatica patients experiencing severe immobility',
      'Patients requiring palliative and Parkinson’s mobility support at home',
    ],
    durationInfo: '45 to 60 minutes per home session. Flexible weekly packages available across South Chennai.',
    faqs: [
      {
        question: 'Which areas in Chennai are covered for home visits?',
        answer: 'We provide home visit physiotherapy across Perungudi, OMR (Kandanchavadi to Sholinganallur), Velachery, Thoraipakkam, Madipakkam, Palavakkam, and neighboring South Chennai areas.',
      },
      {
        question: 'What equipment do the therapists bring during home visits?',
        answer: 'Our therapists bring portable electrotherapy devices (TENS/IFT), resistance exercise bands, joint mobilization equipment, and gait training aids tailored to the patient’s personalized protocol.',
      },
      {
        question: 'How do I book a home visit session?',
        answer: 'You can book directly via our online appointment form by choosing "Home Visit", call our clinic desk at 90940 26006, or send a quick WhatsApp message to schedule a visit.',
      },
    ],
    relatedConditions: ['knee-osteoarthritis', 'low-back-pain-sciatica'],
    relatedServices: ['post-surgical-rehab', 'geriatric-physiotherapy', 'neuro-rehabilitation'],
    seoTitle: 'Home Visit Physiotherapy in Perungudi & OMR Chennai | GG Physio',
    seoDescription: 'Expert home visit physiotherapy across Perungudi, Velachery, Thoraipakkam, and OMR Chennai for elderly, post-surgical, and neuro-rehabilitation patients.',
    published: true,
    displayOrder: 7,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
...
export const defaultFAQs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Yes! We provide specialized home visit physiotherapy across Perungudi, Velachery, Thoraipakkam, Madipakkam, and the OMR corridor for patients recovering from surgery, elderly individuals, stroke survivors, or anyone with restricted mobility.',
    category: 'Appointments',
    displayOrder: 7,
    published: true,
  },
