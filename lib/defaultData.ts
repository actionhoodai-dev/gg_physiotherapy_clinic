...
export const defaultHomepageCMS: HomepageCMS = {
  announcement: {
    text: 'Now accepting appointments for In-Clinic, Home Visits & Online Consultations in Perungudi & OMR, Chennai.',
    enabled: true,
    linkText: 'Book Slot',
    linkUrl: '/appointment',
  },
  ...
  aboutClinic: {
    ...
    bulletPoints: [
      ...
      'Home visit options for elderly and post-op patients in OMR/South Chennai',
    ],
  ...
  whyChooseUs: [
    ...
    },
    {
      ...
      description: 'Available at our Perungudi clinic, at your doorstep (Home Visit), or via Tele-rehab.',
      icon: 'Home',
    },
  ],
  treatmentProcess: [
...
export const defaultServices: ServiceItem[] = [
  ...
  },
  {
    ...
    durationInfo: '60 minutes. Home visit sessions available for non-ambulatory patients.',
    faqs: [
      {
        question: 'Do you offer home visit physiotherapy for stroke patients?',
        answer: 'Yes! We provide dedicated home visit physiotherapy across Perungudi, Velachery, Thoraipakkam, and nearby OMR areas for patients unable to travel to the clinic.',
      },
    ],
    ...
    seoDescription: 'Compassionate neuro rehabilitation for stroke recovery, paralysis, Bell’s palsy, and Parkinson’s disease in Chennai with clinic & home visits.',
    published: true,
    displayOrder: 4,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    ...
    faqs: [
      {
        ...
        answer: 'Gentle bed exercises typically begin within 24-48 hours post-op, and structured outpatient or home visit physiotherapy starts as soon as you are discharged from the hospital.',
      },
    ],
    ...
    seoDescription: 'Post-surgical rehabilitation for knee replacement, hip replacement, and spine surgeries in Perungudi Chennai with clinic and home visit care.',
    published: true,
    displayOrder: 5,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
...
export const defaultTestimonials: TestimonialItem[] = [
  ...
  },
  {
    ...
    treatment: 'Post-Op Knee Replacement (Home Visit)',
    rating: 5,
    review: 'Arranged home visit physiotherapy for my 72-year-old mother after her knee replacement surgery. The clinic team was punctual, gentle, and encouraged her every day. Within 3 weeks my mother was able to walk independently. Thank you Dr. Sundaravalli madam.',
...
export const defaultFAQs: FAQItem[] = [
  ...
  {
    id: 'faq-3',
    question: 'Do you offer Home Visit Physiotherapy in Chennai?',
    answer: 'Yes! We provide dedicated home visit physiotherapy services across Perungudi, Thoraipakkam, Velachery, Taramani, and surrounding South Chennai areas for elderly, post-operative, and mobility-restricted patients.',
    category: 'Services',
    displayOrder: 3,
    published: true,
  },
...
export const defaultSEOSettings: SEOSettings = {
  ...
  keywords: [
    ...
    'home visit physiotherapy chennai',
